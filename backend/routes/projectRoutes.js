...
//router.get('/', authMiddleware, projectController.getAllProjectTitles); // Get all project titles
...
//router.get('/:id', authMiddleware, projectController.getProjectById); // Get project by ID
