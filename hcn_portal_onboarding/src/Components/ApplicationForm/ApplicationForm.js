...
const schema = yup.object().shape({
    ...
    workAuthorizationStatus: yup.string().required("Work authorization status is required"),
    workAuthorizationType: yup.string().required("Work authorization type is required"),
    ...
    <div className="section-heading">
        ...
        <div className="two-column-grid">
          <div>
            ...
            <p className="error-text">{errors.citizenshipStatus?.message}</p>
          </div>
          <div>
            ...
            <p className="error-text">{errors.workAuthorizationStatus?.message}</p>
          </div>
        </div>
        ...
        <div style={{ width: "400px" }}>
          ...
          />
          <p className="error-text">{errors.workAuthorizationType?.message}</p>
        </div>
     ...
     <div className="section-heading">
        ...
        <div className="input-field-single" style={{ width: "250px" }}>
            ...
            <select {...register("highestDegreeEarned")} className="input-field">
            ...
            <p className="error-text">{errors.highestDegreeEarned?.message}</p>
        </div>
      ...
      {/* <div className="application-form"> */}
        <div className="input-field-single" style={{ width: '368px' }}>
          ...
          <select {...register('totalYearsExperience')} className="input-field">
            <option value="">Dropdown option</option>
          ...
          <p className="error-text">{errors.totalYearsExperience?.message}</p>
        </div>
        ...
        <div className="input-field-single">
          <label>Why do you want to join Hoosier Community Network? *</label>
          <textarea
            {...register('whyJoin')}
            className="input-field"
